...
namespace PQ.Sepia2
{
  public static partial class Sepia2_Lib
  {
    ...
    /**/
    #region constants and structs are from 'Sepia2_Def.h'
    ...
    public const string LIB_VERSION_REFERENCE_WIN64 = "1.2.64.*";                               // this is the part to compare with, but ignore the asterisk
    public const string LIB_VERSION_REFERENCE_WIN32 = "1.2.32.*";                               // this is the part to compare with, but ignore the asterisk

    public static string LIB_VERSION_REFERENCE
    {
      get
      {
        if (System.IntPtr.Size == 8)
          return LIB_VERSION_REFERENCE_WIN64;
        else
          return LIB_VERSION_REFERENCE_WIN32;
      }
    }

    public const int SEPIA2_VERSIONINFO_LEN = 11;                                               // "1.2.xx.nnn\0" where xx is either 32 or 64 and nnn is the SVN build number
    public const int LIB_VERSION_REFERENCE_COMPLEN = 7;

    public const int SEPIA2_FW_VERSIONINFO_LEN = 10;                                            // "2.01.nnn\0" where nnn is the firmware build number
    public const string FW_VERSION_REFERENCE_OLD = "1.05.";
    public const string FW_VERSION_REFERENCE = "2.01.";

    public const int FW_VERSION_REFERENCE_COMPLEN = 5;

    public const int SEPIA2_MAX_USB_DEVICES = 8;

    public const int SEPIA2_PRODID = 7;

    public const int SEPIA2_STRDSCR_IDX_VENDOR = 1;
    public const int SEPIA2_STRDSCR_IDX_MODEL = 2;
    public const int SEPIA2_STRDSCR_IDX_BUILD = 3;
    public const int SEPIA2_STRDSCR_IDX_SERIAL = 4;

    public const int SEPIA2_SUPREQ_OPT_NO_PREAMBLE = 0x0001;
    public const int SEPIA2_SUPREQ_OPT_NO_TITLE = 0x0002;
    public const int SEPIA2_SUPREQ_OPT_NO_CALLING_SW_INDENT = 0x0004;
    public const int SEPIA2_SUPREQ_OPT_NO_SYSTEM_INFO = 0x0008;


    // error codes  --------------------------------------------------------------------------------------------------------------
    public const int SEPIA2_NO_ERROR = 0;
    ...
    public const int SEPIA2_SWS_MODULETYPE_LEN = 20;
    public const int SEPIA2_SWS_MODULESTATE_LEN = 20;
    public const int SEPIA2_VUV_VIR_DEVTYPE_LEN = 32;
    public const int SEPIA2_VUV_VIR_TRIGINFO_LEN = 15;
    public const int SEPIA2_PRI_DEVICE_ID_LEN = 6;
    public const int SEPIA2_PRI_DEVTYPE_LEN = 32;
    public const int SEPIA2_PRI_DEVICE_FW_LEN = 8;
    public const int SEPIA2_PRI_OPERMODE_LEN = 16;
    public const int SEPIA2_PRI_TRIGSRC_LEN = 26;
    ...
    //                                                          //
    public const int SEPIA2OBJECT_FRMS = 0xC0;                  // 1 1 00  0 000     backplane primary   no    no   small  0      // primary backplane, small
    public const int SEPIA2OBJECT_FRML = 0xC8;                  // 1 1 00  1 000     backplane primary   no    no   large  0      // primary backplane, large
    public const int SEPIA2OBJECT_SCM = 0x40;                   // 0 1 00  0 000     module    primary   no    no   d.c.   0      // for Sepia II: Controller Modules (Safety Board)
    public const int SEPIA2OBJECT_SLC = 0x41;                   // 0 1 00  0 001     module    primary   no    no   d.c.   1      // for Solea: Laser Coupler
    public const int SEPIA2OBJECT_SLT = 0x42;                   // 0 1 00  0 010     module    primary   no    no   d.c.   2      // for Module Commissioning Site: Voltage Meter Module
    public const int SEPIA2OBJECT_SWM = 0x43;                   // 0 1 00  0 011     module    primary   no    no   d.c.   3      // for PPL 400: Waveform Shaper Modules
    public const int SEPIA2OBJECT_SWS = 0x44;                   // 0 1 00  0 100     module    primary   no    no   d.c.   4      // for Solea: Wavelength Selector Modules
    public const int SEPIA2OBJECT_SPM = 0x45;                   // 0 1 00  0 101     module    primary   no    no   d.c.   5      // for Solea: Pumpcontrol Modules
    public const int SEPIA2OBJECT_LMP1 = 0x46;                  // 0 1 00  0 110     module    primary   no    no   small  6      // for Laser Test Site: Meter Module w. Shutter Control
    public const int SEPIA2OBJECT_LMP8 = 0x4E;                  // 0 1 00  1 110     module    primary   no    no   large  6      // for Laser Test Site: 8 Meter Modules
    public const int SEPIA2OBJECT_SOM = 0x50;                   // 0 1 01  0 000     module    primary   no    yes  d.c.   0      // for Sepia II: Oscillator Modules
    public const int SEPIA2OBJECT_SOMD = 0x51;                  // 0 1 01  0 001     module    primary   no    yes  d.c.   1      // for Sepia II: Oscillator Modules with Delay
    public const int SEPIA2OBJECT_SML = 0x60;                   // 0 1 10  0 000     module    primary   yes   no   d.c.   0      // for Sepia II: Multi Laser Modules
    ...
    public const int SEPIA2OBJECT_SLM = 0x70;                   // 0 1 11  0 000     module    primary   yes   yes  d.c.   0      // for Sepia II: Laser Driver Modules
    public const int SEPIA2OBJECT_SSM = 0x71;                   // 0 1 11  0 001     module    primary   yes   yes  d.c.   1      // for Solea: Seed Laser Modules
    public const int SEPIA2OBJECT_VIR = 0x72;                   // 0 1 11  0 010     module    primary   yes   yes  d.c.   2      // for VisIR: Laser Modules
    public const int SEPIA2OBJECT_VUV = 0x73;                   // 0 1 11  0 011     module    primary   yes   yes  d.c.   3      // for VisUV: Laser Modules
    public const int SEPIA2OBJECT_PRI = 0x74;                   // 0 1 11  0 100     module    primary   yes   yes  d.c.   4      // for Prima: Laser Modules (PUMUCL)
    public const int SEPIA2OBJECT_LHS = 0x20;                   // 0 0 10  0 000     module    secondary yes   no   slow   0      // for Sepia II: Laser Head slow
    public const int SEPIA2OBJECT_LHF = 0x28;                   // 0 0 10  1 000     module    secondary yes   no   fast   0      // for Sepia II: Laser Head fast
    public const int SEPIA2OBJECT_LH_ = 0x29;                   // 0 0 10  1 001     module    secondary yes   no   fast   1
    ...
    public const int SEPIA2_SOMD_TRIGMODE_RISING = 0;
    public const int SEPIA2_SOMD_TRIGMODE_FALLING = 1;
    public const int SEPIA2_SOMD_INT_OSC_A = 2;
    public const int SEPIA2_SOMD_INT_OSC_B = 3;
    public const int SEPIA2_SOMD_INT_OSC_C = 4;
    public const int SEPIA2_SOMD_FREQ_TRIGMODE_COUNT = 5;
    ...
    public struct T_SPM_SensorData
    {
      ...
      ushort wOverAllCurrent;
      ushort wOptionalSensor1;
      ushort wOptionalSensor2;
    };

    #endregion constants and structs are from 'Sepia2_Def.h'
  }
}
