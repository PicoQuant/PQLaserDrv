# The following constants are from 'Sepia2_ErrorCodes.h'
# -----------------------------------------------------------------------------
#
#     Sepia2_ErrorCodes.h
#
...
#
#   apo  20.01.21 raised library version to 1.2 due to USB driver changes
#
...
SEPIA2_ERR_FW_INSUFFICIENT_FW_VERSION = -1007            #   "FW: insufficient FW version"
SEPIA2_ERR_FW_WRONG_WORKINGMODE = -1008              #   "FW: wrong workingmode"
...
SEPIA2_ERR_SOM_ILLEGAL_FREQUENCY_DIVIDER = -5009           #   "SOM: illegal frequency divider"
...
SEPIA2_ERR_SOMD_ILLEGAL_FREQUENCY_DIVIDER = -5059          #   "SOMD: illegal frequency divider"
...
SEPIA2_ERR_PRI_UI_CONSTANTS_TABLES_NOT_FOUND = -6531                #  "PRI: UI-constants tables not found"
...
SEPIA2_ERR_PRI_ERROR_ON_WRITING_WAVELENGTH_INDEX = -6534                #  "PRI: error on writing wavelength index"
SEPIA2_ERR_PRI_OPERATION_MODE_TEXTS_NOT_FOUND = -6535                #  "PRI: operation mode texts not found"
SEPIA2_ERR_PRI_OPERATION_MODE_COMMANDS_NOT_FOUND = -6536                #  "PRI: operation mode commands not found"
SEPIA2_ERR_PRI_ILLEGAL_OPERATION_MODE_INDEX = -6537                #  "PRI: illegal operation mode index"
SEPIA2_ERR_PRI_ERROR_ON_WRITING_OPERATION_MODE_INDEX = -6538                #  "PRI: error on writing operation mode index"
SEPIA2_ERR_PRI_TRIGGER_SOURCE_TEXTS_NOT_FOUND = -6539                #  "PRI: trigger source texts not found"
SEPIA2_ERR_PRI_TRIGGER_SOURCE_COMMANDS_NOT_FOUND = -6540                #  "PRI: trigger source commands not found"
SEPIA2_ERR_PRI_ILLEGAL_TRIGGER_SOURCE_INDEX = -6541                #  "PRI: illegal trigger source index"
SEPIA2_ERR_PRI_ERROR_ON_WRITING_TRIGGER_SOURCE_INDEX = -6542                #  "PRI: error on writing trigger source index"
SEPIA2_ERR_PRI_ILLEGAL_TRIGGER_LEVEL = -6543                #  "PRI: illegal trigger level"
SEPIA2_ERR_PRI_ERROR_ON_WRITING_TRIGGER_LEVEL = -6544                #  "PRI: error on writing trigger level"
SEPIA2_ERR_PRI_ILLEGAL_INTENSITY_DATA = -6545                #  "PRI: illegal intensity data"
SEPIA2_ERR_PRI_ERROR_ON_WRITING_INTENSITY_DATA = -6546                #  "PRI: error on writing intensity data"
SEPIA2_ERR_PRI_ILLEGAL_FREQUENCY_DATA = -6547                #  "PRI: illegal frequency data"
SEPIA2_ERR_PRI_ERROR_ON_WRITING_FREQUENCY_DATA = -6548                #  "PRI: error on writing frequency data"
SEPIA2_ERR_PRI_ILLEGAL_GATING_DATA = -6549                #  "PRI: illegal gating data"
SEPIA2_ERR_PRI_ERROR_ON_WRITING_GATING_DATA = -6550                #  "PRI: error on writing gating data"
SEPIA2_ERR_SWM_CALTABLES_NOT_FOUND = -6701             #   "SWM: calibration tables not found"
...
SEPIA2_ERR_VCL_UI_CONSTANTS_NOT_FOUND = -6751            #   "VCL: UI-constants not found"
SEPIA2_ERR_VCL_TEMPERATURE_CALTABLE_NOT_FOUND = -6752        #   "VCL: temperature calibration table not found"
SEPIA2_ERR_VCL_BIAS_VOLTAGE_CALTABLE_NOT_FOUND = -6753       #   "VCL: bias voltage calibration table not found"
SEPIA2_ERR_VCL_ILLEGAL_TEMPERATURE = -6754             #   "VCL: illegal temperature"
SEPIA2_ERR_VCL_ILLEGAL_BIAS_VOLTAGE = -6755            #   "VCL: illegal bias voltage"
#
SEPIA2_ERR_SPM_ILLEGAL_INPUT_VALUE = -7001             #   "SPM: illegal input value"
SEPIA2_ERR_SPM_VALUE_OUT_OF_BOUNDS = -7006             #   "SPM: value out of bounds"
SEPIA2_ERR_SPM_FW_OUT_OF_MEMORY = -7011              #   "SPM FW: out of memory"
SEPIA2_ERR_SPM_FW_UPDATE_FAILED = -7013              #   "SPM FW: update failed"
SEPIA2_ERR_SPM_FW_CRC_CHECK_FAILED = -7014             #   "SPM FW: CRC check failed"
SEPIA2_ERR_SPM_FW_FLASH_DELETION_FAILED = -7015          #   "SPM FW: flash deletion failed"
SEPIA2_ERR_SPM_FW_FUNCTION_NOT_IMPLEMENTED = -7017         #   "SPM FW: function not implemented"
SEPIA2_ERR_SPM_FW_FILE_OPEN_ERROR = -7021              #   "SPM FW: file open error"
SEPIA2_ERR_SPM_FW_FILE_READ_ERROR = -7022              #   "SPM FW: file read error"
SEPIA2_ERR_SSM_SCALING_TABLES_NOT_FOUND = -7051          #   "SSM: scaling tables not found"
SEPIA2_ERR_SSM_ILLEGAL_TRIGGER_MODE = -7052            #   "SSM: illegal trigger mode"
SEPIA2_ERR_SSM_ILLEGAL_TRIGGER_LEVEL_VALUE = -7053         #   "SSM: illegal trigger level value"
SEPIA2_ERR_SSM_ILLEGAL_CORRECTION_VALUE = -7054          #   "SSM: illegal correction value"
SEPIA2_ERR_SSM_TRIGGER_DATA_NOT_FOUND = -7055            #   "SSM: trigger data not found"
SEPIA2_ERR_SSM_CORRECTION_DATA_COMMAND_NOT_FOUND = -7056       #   "SSM: correction data command not found"
SEPIA2_ERR_SWS_SCALING_TABLES_NOT_FOUND = -7101          #   "SWS: scaling tables not found"
SEPIA2_ERR_SWS_ILLEGAL_HW_MODULETYPE = -7102             #   "SWS: illegal HW moduletype"
SEPIA2_ERR_SWS_MODULE_NOT_FUNCTIONAL = -7103             #   "SWS: module not functional"
SEPIA2_ERR_SWS_ILLEGAL_CENTER_WAVELENGTH = -7104           #   "SWS: illegal center wavelength"
SEPIA2_ERR_SWS_ILLEGAL_BANDWIDTH = -7105               #   "SWS: illegal bandwidth"
SEPIA2_ERR_SWS_VALUE_OUT_OF_BOUNDS = -7106             #   "SWS: value out of bounds"
SEPIA2_ERR_SWS_MODULE_BUSY = -7107                 #   "SWS: module busy"
SEPIA2_ERR_SWS_FW_WRONG_COMPONENT_ANSWERING = -7109        #   "SWS FW: wrong component answering"
SEPIA2_ERR_SWS_FW_UNKNOWN_HW_MODULETYPE = -7110          #   "SWS FW: unknown HW moduletype"
SEPIA2_ERR_SWS_FW_OUT_OF_MEMORY = -7111              #   "SWS FW: out of memory"
SEPIA2_ERR_SWS_FW_VERSION_CONFLICT = -7112             #   "SWS FW: version conflict"
SEPIA2_ERR_SWS_FW_UPDATE_FAILED = -7113              #   "SWS FW: update failed"
SEPIA2_ERR_SWS_FW_CRC_CHECK_FAILED = -7114             #   "SWS FW: CRC check failed"
SEPIA2_ERR_SWS_FW_ERROR_ON_FLASH_DELETION = -7115          #   "SWS FW: error on flash deletion"
SEPIA2_ERR_SWS_FW_CALIBRATION_MODE_ERROR = -7116           #   "SWS FW: calibration mode error"
SEPIA2_ERR_SWS_FW_FUNCTION_NOT_IMPLEMENTED = -7117         #   "SWS FW: function not implemented"
SEPIA2_ERR_SWS_FW_WRONG_CALTABLE_ENTRY = -7118           #   "SWS FW: wrong calibration table entry"
SEPIA2_ERR_SWS_FW_INSUFFICIENT_CALTABLE_SIZE = -7119         #   "SWS FW: insufficient calibration table size"
SEPIA2_ERR_SWS_FW_FILE_OPEN_ERROR = -7151              #   "SWS FW: file open error"
SEPIA2_ERR_SWS_FW_FILE_READ_ERROR = -7152              #   "SWS FW: file read error"
SEPIA2_ERR_SWS_HW_MODULE_0_ALL_MOTORS_INIT_TIMEOUT = -7201     #   "SWS HW: module 0, all motors: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_ALL_MOTORS_PLAUSI_CHECK = -7202     #   "SWS HW: module 0, all motors: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_0_ALL_MOTORS_DAC_SET_CURRENT = -7203    #   "SWS HW: module 0, all motors: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_0_ALL_MOTORS_TIMEOUT = -7204   #   "SWS HW: module 0, all motors: timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_ALL_MOTORS_FLASH_WRITE_ERROR = -7205   #   "SWS HW: module 0, all motors: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_0_ALL_MOTORS_OUT_OF_BOUNDS = -7206   #   "SWS HW: module 0, all motors: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_0_I2C_FAILURE = -7207   #   "SWS HW: module 0: I2C failure"
SEPIA2_ERR_SWS_HW_MODULE_0_INIT_FAILURE = -7208   #   "SWS HW: module 0: init failure"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_1_DATA_NOT_FOUND = -7210   #   "SWS HW: module 0, motor 1: data not found"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_1_INIT_TIMEOUT = -7211   #   "SWS HW: module 0, motor 1: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_1_PLAUSI_CHECK = -7212   #   "SWS HW: module 0, motor 1: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_1_DAC_SET_CURRENT = -7213   #   "SWS HW: module 0, motor 1: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_1_TIMEOUT = -7214   #   "SWS HW: module 0, motor 1: timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_1_FLASH_WRITE_ERROR = -7215   #   "SWS HW: module 0, motor 1: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_1_OUT_OF_BOUNDS = -7216   #   "SWS HW: module 0, motor 1: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_2_DATA_NOT_FOUND = -7220   #   "SWS HW: module 0, motor 2: data not found"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_2_INIT_TIMEOUT = -7221   #   "SWS HW: module 0, motor 2: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_2_PLAUSI_CHECK = -7222   #   "SWS HW: module 0, motor 2: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_2_DAC_SET_CURRENT = -7223   #   "SWS HW: module 0, motor 2: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_2_TIMEOUT = -7224   #   "SWS HW: module 0, motor 2: timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_2_FLASH_WRITE_ERROR = -7225   #   "SWS HW: module 0, motor 2: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_2_OUT_OF_BOUNDS = -7226   #   "SWS HW: module 0, motor 2: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_3_DATA_NOT_FOUND = -7230   #   "SWS HW: module 0, motor 3: data not found"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_3_INIT_TIMEOUT = -7231   #   "SWS HW: module 0, motor 3: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_3_PLAUSI_CHECK = -7232   #   "SWS HW: module 0, motor 3: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_3_DAC_SET_CURRENT = -7233   #   "SWS HW: module 0, motor 3: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_3_TIMEOUT = -7234   #   "SWS HW: module 0, motor 3: timeout"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_3_FLASH_WRITE_ERROR = -7235   #   "SWS HW: module 0, motor 3: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_0_MOTOR_3_OUT_OF_BOUNDS = -7236   #   "SWS HW: module 0, motor 3: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_1_ALL_MOTORS_INIT_TIMEOUT = -7301   #   "SWS HW: module 1, all motors: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_ALL_MOTORS_PLAUSI_CHECK = -7302   #   "SWS HW: module 1, all motors: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_1_ALL_MOTORS_DAC_SET_CURRENT = -7303   #   "SWS HW: module 1, all motors: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_1_ALL_MOTORS_TIMEOUT = -7304   #   "SWS HW: module 1, all motors: timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_ALL_MOTORS_FLASH_WRITE_ERROR = -7305   #   "SWS HW: module 1, all motors: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_1_ALL_MOTORS_OUT_OF_BOUNDS = -7306   #   "SWS HW: module 1, all motors: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_1_I2C_FAILURE = -7307   #   "SWS HW: module 1: I2C failure"
SEPIA2_ERR_SWS_HW_MODULE_1_INIT_FAILURE = -7308   #   "SWS HW: module 1: init failure"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_1_DATA_NOT_FOUND = -7310   #   "SWS HW: module 1, motor 1: data not found"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_1_INIT_TIMEOUT = -7311   #   "SWS HW: module 1, motor 1: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_1_PLAUSI_CHECK = -7312   #   "SWS HW: module 1, motor 1: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_1_DAC_SET_CURRENT = -7313   #   "SWS HW: module 1, motor 1: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_1_TIMEOUT = -7314   #   "SWS HW: module 1, motor 1: timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_1_FLASH_WRITE_ERROR = -7315   #   "SWS HW: module 1, motor 1: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_1_OUT_OF_BOUNDS = -7316   #   "SWS HW: module 1, motor 1: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_2_DATA_NOT_FOUND = -7320   #   "SWS HW: module 1, motor 2: data not found"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_2_INIT_TIMEOUT = -7321   #   "SWS HW: module 1, motor 2: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_2_PLAUSI_CHECK = -7322   #   "SWS HW: module 1, motor 2: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_2_DAC_SET_CURRENT = -7323   #   "SWS HW: module 1, motor 2: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_2_TIMEOUT = -7324   #   "SWS HW: module 1, motor 2: timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_2_FLASH_WRITE_ERROR = -7325   #   "SWS HW: module 1, motor 2: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_2_OUT_OF_BOUNDS = -7326   #   "SWS HW: module 1, motor 2: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_3_DATA_NOT_FOUND = -7330   #   "SWS HW: module 1, motor 3: data not found"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_3_INIT_TIMEOUT = -7331   #   "SWS HW: module 1, motor 3: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_3_PLAUSI_CHECK = -7332   #   "SWS HW: module 1, motor 3: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_3_DAC_SET_CURRENT = -7333   #   "SWS HW: module 1, motor 3: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_3_TIMEOUT = -7334   #   "SWS HW: module 1, motor 3: timeout"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_3_FLASH_WRITE_ERROR = -7335   #   "SWS HW: module 1, motor 3: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_1_MOTOR_3_OUT_OF_BOUNDS = -7336   #   "SWS HW: module 1, motor 3: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_2_ALL_MOTORS_INIT_TIMEOUT = -7401   #   "SWS HW: module 2, all motors: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_ALL_MOTORS_PLAUSI_CHECK = -7402   #   "SWS HW: module 2, all motors: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_2_ALL_MOTORS_DAC_SET_CURRENT = -7403   #   "SWS HW: module 2, all motors: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_2_ALL_MOTORS_TIMEOUT = -7404   #   "SWS HW: module 2, all motors: timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_ALL_MOTORS_FLASH_WRITE_ERROR = -7405   #   "SWS HW: module 2, all motors: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_2_ALL_MOTORS_OUT_OF_BOUNDS = -7406   #   "SWS HW: module 2, all motors: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_2_I2C_FAILURE = -7407   #   "SWS HW: module 2: I2C failure"
SEPIA2_ERR_SWS_HW_MODULE_2_INIT_FAILURE = -7408   #   "SWS HW: module 2: init failure"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_1_DATA_NOT_FOUND = -7410   #   "SWS HW: module 2, motor 1: data not found"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_1_INIT_TIMEOUT = -7411   #   "SWS HW: module 2, motor 1: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_1_PLAUSI_CHECK = -7412   #   "SWS HW: module 2, motor 1: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_1_DAC_SET_CURRENT = -7413   #   "SWS HW: module 2, motor 1: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_1_TIMEOUT = -7414   #   "SWS HW: module 2, motor 1: timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_1_FLASH_WRITE_ERROR = -7415   #   "SWS HW: module 2, motor 1: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_1_OUT_OF_BOUNDS = -7416   #   "SWS HW: module 2, motor 1: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_2_DATA_NOT_FOUND = -7420   #   "SWS HW: module 2, motor 2: data not found"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_2_INIT_TIMEOUT = -7421   #   "SWS HW: module 2, motor 2: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_2_PLAUSI_CHECK = -7422   #   "SWS HW: module 2, motor 2: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_2_DAC_SET_CURRENT = -7423   #   "SWS HW: module 2, motor 2: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_2_TIMEOUT = -7424   #   "SWS HW: module 2, motor 2: timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_2_FLASH_WRITE_ERROR = -7425   #   "SWS HW: module 2, motor 2: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_2_OUT_OF_BOUNDS = -7426   #   "SWS HW: module 2, motor 2: out of bounds"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_3_DATA_NOT_FOUND = -7430   #   "SWS HW: module 2, motor 3: data not found"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_3_INIT_TIMEOUT = -7431   #   "SWS HW: module 2, motor 3: init timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_3_PLAUSI_CHECK = -7432   #   "SWS HW: module 2, motor 3: plausi check"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_3_DAC_SET_CURRENT = -7433   #   "SWS HW: module 2, motor 3: DAC set current"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_3_TIMEOUT = -7434   #   "SWS HW: module 2, motor 3: timeout"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_3_FLASH_WRITE_ERROR = -7435   #   "SWS HW: module 2, motor 3: flash write error"
SEPIA2_ERR_SWS_HW_MODULE_2_MOTOR_3_OUT_OF_BOUNDS = -7436   #   "SWS HW: module 2, motor 3: out of bounds"
#
...
SEPIA2_ERR_LIB_THIS_IS_NO_SSM_MODULE = -9015   #   "LIB: this is no SSM module"
SEPIA2_ERR_LIB_THIS_IS_NO_SWS_MODULE = -9016   #   "LIB: this is no SWS module"
SEPIA2_ERR_LIB_THIS_IS_NO_SPM_MODULE = -9017   #   "LIB: this is no SPM module"
...
SEPIA2_ERR_LIB_THIS_IS_NO_VCL_828_MODULE = -9022   #   "LIB: this is no VCL 828 module"
SEPIA2_ERR_LIB_THIS_IS_NO_VUV_NOR_VIR_MODULE = -9023   #   "LIB: this is no VUV nor VIR module"
SEPIA2_ERR_LIB_THIS_IS_NO_PRI_MODULE = -9024   #   "LIB: this is no PRI module"
